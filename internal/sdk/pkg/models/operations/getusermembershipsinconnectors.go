...
type GetUserMembershipsInConnectorsRequest struct {
...
type GetUserMembershipsInConnectorsResponse struct {
	ContentType string
	StatusCode  int
	RawResponse *http.Response
	// Successful response
	GetUserMembershipsInConnectors200ApplicationJSONAny interface{}
}
